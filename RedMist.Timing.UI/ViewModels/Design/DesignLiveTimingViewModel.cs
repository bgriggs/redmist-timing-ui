...
{
    public DesignLiveTimingViewModel() : base(new HubClient(new DebugLoggerFactory(), new DesignConfiguration(), new EventAccessCodeStore(new MockPreferencesService())), new DesignEventClient(new DesignConfiguration()), new DebugLoggerFactory(), new ViewSizeService(), new EventContext(), new DesignHttpClientFactory(), new DesignConfiguration(), new DesignOrganizationIconCacheService(), new SponsorRotatorViewModel(new SponsorsService(new DesignSponsorClient(), new SponsorIconCacheService(DesignImageStore.Create(), new DebugLoggerFactory()), new DebugLoggerFactory()), new SponsorIconCacheService(DesignImageStore.Create(), new DebugLoggerFactory()), new DesignSponsorClient(), new DebugLoggerFactory()))
    {
